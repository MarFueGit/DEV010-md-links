...
// es la declaración de la función getHrefLinks que recibe 2 parametros
const getHrefLinks = (html, pathToValidate) => {
  // Es la declaracion de la variable dom en donde se almacenara una instancia de JSDOM
